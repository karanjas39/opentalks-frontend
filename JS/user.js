...
async function getDetails() {
  try {
    ...
    let response2 = fetch("https://opentalks-backend.vercel.app/api/stats", {
      method: "POST",
    ...
    let response3 = fetch(
      "https://opentalks-backend.vercel.app/api/post/recent",
      {
        method: "POST",
        body: JSON.stringify({
    ...
    let response4 = fetch(
      "https://opentalks-backend.vercel.app/api/forum/top",
      {
        method: "POST",
        headers: {
          "Content-type": "application/json;charset=utf-8",
    ...
    let response6 = fetch(
      "https://opentalks-backend.vercel.app/api/post/reply/recent",
      {
        method: "POST",
        body: JSON.stringify({
          userId: sessionStorage.getItem("user"),
...
async function sentForumJoinRequest(forumId) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/join/request",
      {
        method: "POST",
        body: JSON.stringify({
          forumId,
...
async function updateUserProfileMain(updateData, password) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/update/details",
      {
        method: "POST",
        body: JSON.stringify({
          ...updateData,
...
async function updateUserPicMain(password) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/update/image",
      {
        method: "POST",
        body: formData,
        headers: {
    ...
    if (!!data && data.success == true) {
      ...
      ).src = `https://opentalks-backend.vercel.app${user_details.user.image}`;
      document.querySelector(
...
async function fetchNotifications() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/notification/all",
      {
        method: "POST",
        body: JSON.stringify({
          userId: sessionStorage.getItem("user"),
...
async function clearNotifications() {
  try {
    ...
    await fetch(
      "https://opentalks-backend.vercel.app/api/notification/delete/all",
      {
        method: "POST",
        body: JSON.stringify({
          userId: sessionStorage.getItem("user"),
...
async function updateUserPassword(prevPassword, newPassword) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/update/password",
      {
        method: "POST",
        body: JSON.stringify({
          userId: sessionStorage.getItem("user"),
...
async function userRecentPosts() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/post/recent/5",
      {
        method: "POST",
...
async function userLikedPosts() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/post/top",
      {
        method: "POST",
        body: JSON.stringify({ userId: sessionStorage.getItem("user") }),
        headers: {
...
async function fetchFavouritePosts() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/post/favourite",
      {
        method: "POST",
        body: JSON.stringify({
          userId: sessionStorage.getItem("user"),
  ...
  <div class="favourite-main-post-bottom">
    ...
    <div class="favourite-main-post-info">
      <img
        src="https://opentalks-backend.vercel.app${el.postId.userId.image}"
...
async function fetchCreatedForums() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/created/detail",
      {
        method: "POST",
        body: JSON.stringify({ userId: sessionStorage.getItem("user") }),
        headers: {
...
async function fetchJoinedForums() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/join/member",
      {
        method: "POST",
        body: JSON.stringify({
          userId: sessionStorage.getItem("user"),
...
async function fetchForumData_initially(forumId, joined = false) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/detail",
      {
        method: "POST",
        body: JSON.stringify({
          _id: forumId,
...
async function updateForumDetailsMain(password, query) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/update",
      {
        method: "POST",
        body: JSON.stringify({
          _id: createdForumID,
...
async function fetchForumMemberScroll() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/join/member/search",
      {
        method: "POST",
        body: JSON.stringify({
...
async function removeForumMemberMain(password, query) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/join/left",
      {
        method: "POST",
        body: JSON.stringify({
          forumId: createdForumID,
...
async function fetchAllComplaints() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/complaint/all",
      {
        method: "POST",
        body: JSON.stringify({ forumId: createdForumID }),
        headers: {
...
async function fetchJoinedForumComplaints() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/complaint/user/all",
      {
        method: "POST",
        body: JSON.stringify({
...
async function fetchSearchedComplaintinJoinedForum() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/complaint/search",
      {
        method: "POST",
        body: JSON.stringify({
...
async function sendResponseToComplaint(complaintId, userId, response, target) {
  ...
  try {
    let response1 = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/response",
      {
        method: "POST",
...
async function fetchComplaintResponses(data1, target) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/response/all",
      {
        method: "POST",
        body: JSON.stringify({
          forumId,
...
async function createComplaint(complaint) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/complaint",
      {
        method: "POST",
        body: JSON.stringify({
          userId: sessionStorage.getItem("user"),
...
async function fetchMemberJoinRequests() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/join/request/list",
      {
        method: "POST",
...
async function respondJoinRequest(target, status) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/join",
      {
        method: "POST",
        body: JSON.stringify({
          userId,
...
async function fetchForumPosts_initially(forumId, joined = false) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/post/all",
      {
        method: "POST",
        body: JSON.stringify({
          forumId,
...
async function likeUserPost(target) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/post/like",
      {
        method: "POST",
        body: JSON.stringify({
          postId,
...
async function unlikeUserPost(target) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/post/unlike",
      {
        method: "POST",
        body: JSON.stringify({
          postId,
...
async function fetchUserComments(target) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/post/reply/all",
      {
        method: "POST",
        body: JSON.stringify({
          postId,
...
async function addPostReply(reply, target, isJoined = false) {
  try {
    ...
    const response = await fetch(
      "https://opentalks-backend.vercel.app/api/post/reply/add",
      {
        method: "POST",
        body: JSON.stringify({
...
async function deleteReplyMain(password, query) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/post/reply/delete",
      {
        method: "POST",
        body: JSON.stringify({
          _id: query.replyId,
...
async function searchForumPost(query) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/post/search",
      {
        method: "POST",
        body: JSON.stringify({
...
async function deleteUserPostMain(password, query) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/post/delete",
      {
        method: "POST",
        body: JSON.stringify({
          postId: query.postId,
...
async function fetchPostLikesUsers(target) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/post/like/user",
      {
        method: "POST",
        body: JSON.stringify({
          postId: target.dataset.postid,
...
async function createPostMain(query, password) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/post/add",
      {
        method: "POST",
        body: JSON.stringify({
          userId: sessionStorage.getItem("user"),
...
async function deleteCreatedForumMain(password) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/delete",
      {
        method: "POST",
        body: JSON.stringify({
          _id: createdForumID,
...
async function fetchForumReviews() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/rate/all",
      {
        method: "POST",
        body: JSON.stringify({
          forumId: createdForumID,
...
async function fetchForumRating() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/rate/get",
      {
        method: "POST",
        body: JSON.stringify({
          userId: sessionStorage.getItem("user"),
...
async function submitForumRating() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/rate",
      {
        method: "POST",
        body: JSON.stringify({
          userId: sessionStorage.getItem("user"),
...
async function searchForumFilter(query) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/join/member/search/filter",
      {
        method: "POST",
        body: JSON.stringify({
          ...query,
...
async function createForumMain(query, password) {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/forum/add",
      {
        method: "POST",
        body: JSON.stringify({
          ...query,
...
async function forgetPassword() {
  try {
    ...
    let response = await fetch(
      "https://opentalks-backend.vercel.app/api/password/forget",
      {
        method: "POST",
        body: JSON.stringify({ userId: sessionStorage.getItem("user") }),
        headers: {
...
document
  ...
  .addEventListener("keydown", async (e) => {
    ...
    if (e.key == "Enter" && target != "") {
      ...
      let response = await fetch(
        "https://opentalks-backend.vercel.app/api/post/search",
        {
          method: "POST",
          body: JSON.stringify({
            search: target,
...
document
  ...
  .addEventListener("keydown", async (event) => {
    ...
    if (event.key == "Enter" && forum_search != "") {
      ...
      let response = await fetch(
        "https://opentalks-backend.vercel.app/api/forum/search",
        {
          method: "POST",
